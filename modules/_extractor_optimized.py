...
def remove_skin(pixel_array: numpy.ndarray, contours: list, method: str, thickness: int = 16):
    ...
    if len(back_line_points) < 2:
        back_line_points = [point for point in body_outline_contour if point[0][1] >= pixel_array.shape[0] // 2 + 48]
...
def find_vertebrae_contour(bone_contours: list):
    ...
    """
    vertebrae_area = [[180, 250], [332, 450]] #LTRB
    vertebrae_points = []
    vertebrea_contour = []
