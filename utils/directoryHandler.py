...
def create_working_dir_structure(patient_id: str, working_dir: str):
    """
    ...
    in_dir = os.path.join(working_dir_with_patient_id, "in")
    ex_dir = os.path.join(working_dir_with_patient_id, "ex")
    os.makedirs(in_dir, exist_ok=True)
    os.makedirs(ex_dir, exist_ok=True)
    return working_dir_with_patient_id, in_dir, ex_dir

def check_processed_data(target_path: str):
    """
